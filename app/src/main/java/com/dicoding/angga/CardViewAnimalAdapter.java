...
public class CardViewAnimalAdapter extends RecyclerView.Adapter<CardViewAnimalAdapter.CardViewViewHolder> {
    ...
    CardViewAnimalAdapter(ArrayList<animal> list) {
    ...
    public void onBindViewHolder(@NonNull final CardViewViewHolder holder, int position) {
        ...
        holder.btnFavorite.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Toast.makeText(holder.itemView.getContext(), "Favorite " +
                        listAnimals.get(holder.getAdapterPosition()).getName(), Toast.LENGTH_SHORT).show();
        ...
        holder.itemView.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Toast.makeText(holder.itemView.getContext(), "Kamu memilih " + listAnimals.get(holder.getAdapterPosition()).getName(), Toast.LENGTH_SHORT).show();
            }
        });
    }
